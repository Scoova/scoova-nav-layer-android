...
android {
    namespace = "com.scoova.navlayer.weather"
    compileSdk = 35
    ...
    publishing {
        publications {
            create<MavenPublication>("release") {
                ...
                artifactId = "nav-layer-weather"
                pom {
                    name.set("Scoova Nav Layer — Weather Adapter")
                    description.set(
                        "Open-Meteo-compatible weather snapshot client for Scoova Nav " +
                            "Layer — temperature + wind + condition for the rider's current point."
                    )
